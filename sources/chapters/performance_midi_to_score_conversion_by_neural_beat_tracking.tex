...
Using this technique we were able to estimate the influence of certain note feature to a model's decision. While the key signature model turned out to be the most robust model of all three considered, 
