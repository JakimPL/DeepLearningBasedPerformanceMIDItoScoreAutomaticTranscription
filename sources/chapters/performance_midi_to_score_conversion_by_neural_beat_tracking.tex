...
The second option may seem rather radical, however the results from ablation studies (Section \ref{ablation_studies}) show that the trade-off between robustness and the model performanc2 on the test score is very small, although not negligible.
