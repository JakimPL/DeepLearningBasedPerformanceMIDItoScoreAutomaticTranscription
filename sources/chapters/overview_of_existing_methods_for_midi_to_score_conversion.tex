...
\centering
\begin{tabular}{cc}a)
\includesvg[width=0.3\textwidth]{images/sonata_original.svg}
 & b)\includesvg[width=0.6\textwidth]{images/sonata_performance.svg}
\end{tabular}
...
\centering
\begin{tabular}{cc}a)
\includesvg[height=1.25cm]{images/score_agnostic.svg}
 & b)\includesvg[height=1.15cm]{images/score_informed.svg}
\end{tabular}
